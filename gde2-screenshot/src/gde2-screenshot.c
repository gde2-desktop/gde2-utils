/* gde2-screenshot.c - Take a screenshot of the desktop
 *
...
#define GDE2_SCREENSHOT_SCHEMA "org.gde2.screenshot"
...
#define CAJA_PREFERENCES_SCHEMA "org.gde2.caja.preferences"
...
display_help (GtkWindow *parent)
{
  ...
  gtk_show_uri (gtk_window_get_screen (parent),
		"help:gde2-user-guide/goseditmainmenu-53",
...
set_recent_entry (ScreenshotDialog *dialog)
{
  ...
  recent_data.app_name = "GDE2 Screenshot";
...
main (int argc, char *argv[])
{
  ...
  settings = g_settings_new (GDE2_SCREENSHOT_SCHEMA);
  load_options ();
