/* screenshot-dialog.c - main GDE2 Screenshot dialog
 *
...
#if GTK_CHECK_VERSION (3, 0, 0)  
  res = gtk_builder_add_from_file (dialog->ui, UIDIR "/gde2-screenshot-gtk3.ui", &error);
#else
  res = gtk_builder_add_from_file (dialog->ui, UIDIR "/gde2-screenshot.ui", &error);
#endif
  ...
  if (res == 0)
    {
      ...
      dialog = gtk_message_dialog_new (NULL, 0,
				       ...
				       _("Error loading UI definition file for the screenshot program: \n%s\n\n"
				         "Please check your installation of gde2-utils."), error->message);
