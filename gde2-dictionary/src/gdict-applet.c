/* gdict-applet.c - GDE2 Dictionary Applet
 *
...
gdict_applet_entry_button_press_event_cb (GtkWidget      *widget,
					  ...
					  GdictApplet    *applet)
{
  gde2_panel_applet_request_focus (GDE2_PANEL_APPLET (applet), event->time);
		       ...
		       GdictApplet       *applet)
{
  ...
  gtk_show_uri (gtk_widget_get_screen (GTK_WIDGET (applet)),
		"help:gde2-dictionary/gde2-dictionary-applet",
...
static void
gdict_applet_change_orient (Gde2PanelApplet       *applet,
			    Gde2PanelAppletOrient  orient)
{
  ...
  if (GDE2_PANEL_APPLET_CLASS (gdict_applet_parent_class)->change_orient)
    GDE2_PANEL_APPLET_CLASS (gdict_applet_parent_class)->change_orient (applet,
    								   orient);
}
...
gdict_applet_class_init (GdictAppletClass *klass)
{
  ...
  Gde2PanelAppletClass *applet_class = GDE2_PANEL_APPLET_CLASS (klass);
...
gdict_applet_init (GdictApplet *applet)
{
  ...
  gde2_panel_applet_set_flags (GDE2_PANEL_APPLET (applet),
			  GDE2_PANEL_APPLET_EXPAND_MINOR);
  ...
  priv->size = gde2_panel_applet_get_size (GDE2_PANEL_APPLET (applet));

  switch (gde2_panel_applet_get_orient (GDE2_PANEL_APPLET (applet)))
    {
    case GDE2_PANEL_APPLET_ORIENT_LEFT:
    case GDE2_PANEL_APPLET_ORIENT_RIGHT:
      priv->orient = GTK_ORIENTATION_VERTICAL;
...
static gboolean
gdict_applet_factory (Gde2PanelApplet *applet,
                      const gchar *iid,
		      gpointer     data)
{
  ...
  if (((!strcmp (iid, "DictionaryApplet"))) && gdict_create_data_dir ())
    {
      ...
      gde2_panel_applet_setup_menu_from_file (applet, ui_path,
...
GDE2_PANEL_APPLET_OUT_PROCESS_FACTORY ("DictionaryAppletFactory",
			     GDICT_TYPE_APPLET,
			     "gde2-dictionary-applet",
