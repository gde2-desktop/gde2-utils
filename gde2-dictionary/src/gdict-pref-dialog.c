 ...
 *
 * This file is part of GDE2 Dictionary
 *
...
#define GDICT_PREFERENCES_UI 	PKGDATADIR "/gde2-dictionary-preferences.ui"
  ...
  switch (response_id)
    ...
    case GTK_RESPONSE_HELP:
      gtk_show_uri (gtk_widget_get_screen (GTK_WIDGET (dialog)),
                    "help:gde2-dictionary/gde2-dictionary-preferences",
