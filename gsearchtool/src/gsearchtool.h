...
#define GDE2_SEARCH_TOOL_ICON "system-search"
...
struct _GSearchWindow {
	...
	GSettings             * gde2_search_tool_settings;
	GSettings             * gde2_search_tool_select_settings;
	GSettings             * gde2_desktop_interface_settings;
